...
BagService.addBagItem = (tripId, bagItem) => __awaiter(void 0, void 0, void 0, function* () {
    const tripAsOwner = yield TripService_1.TripService.getTrip(tripId, bagItem.userId);
    const tripAsTeammate = yield TripService_1.TripService.getTripAsTeammate(tripId, bagItem.userId);
